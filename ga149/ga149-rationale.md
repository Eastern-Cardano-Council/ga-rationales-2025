...
## Rationale Statement
The governance action with ID "gov_action19apfhh339syqd0gkrxw6zr6pghdfspckr6vagjrpwnr0hx53lxpsq637y3t" and title "Revised Cardano dOSPO and OMF Program Proposal" is a Treasury Withdrawal, and is therefore subject to the following sections and guardrails in the Cardano Constitution.
...
- The purpose of the withdrawal as "This proposal is to establish an independent entity dedicated to managing open source sustainability funds for the Cardano ecosystem."
- The period for delivery of proposed activities as "I am requesting funding for one year".
- The relevant costs and expenses under the heading "Full Program Budget Summary", with more details under each Work Package.
- The circumstances under which funds may be refunded to the Cardano Treasury as "The 175,000 ADA portfolio reserve within WP2 is returned at program end if undeployed. The 44,000 ADA activation reserve within WP5 is also returned if undeployed. Unspent operational contingency is returned."
...
- D. Amount of this Treasury Withdrawal: 4094000 ada
- E. "C" plus "D" = 341489629 ada
- F. "A" minus "E" = 158510371 ada
...
This governance action states that "Mill Law Firm serves as independent financial auditor for the full 12-month term." It also allocates 160,000 ADA for "Operational Costs" under "Work Package 1 — Operations and Governance Infrastructure", which refers to the Mill Law Firm financial review under Milestone "M1.3 — Quarterly Reports". These fulfil the requirements of ARTICLE II, Section 7(4).
...
This governance action states that "Christian Taylor / Open Source Cowboy Consulting is the designated Article II.7.5 administrator from the moment of treasury withdrawal through the full 12-month pilot term, unless replaced by an on-chain DRep Info Action.", which fulfils this requirement.
